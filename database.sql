...
CREATE TABLE IF NOT EXISTS puja_bookings (
    ...
    receipt_code VARCHAR(60) DEFAULT NULL,
...
INSERT INTO temples (name, slug, deity_primary, deity_secondary, city, state, region_label, opening_hours, about_text, significance_text, image_theme, image_url) VALUES
...
INSERT INTO pujas (temple_id, name, slug, deity, duration_label, devotees_count, description, price, original_price, is_featured, discount_label, image_theme, image_url, benefits_json) VALUES
...
INSERT INTO products (category_id, name, slug, rating, reviews_count, price, original_price, image_theme, image_url, short_description, stock_qty) VALUES
...
INSERT INTO sevas (name, slug, place_group, description, live_stream_note, price, original_price, badge_label, image_theme, image_url) VALUES
